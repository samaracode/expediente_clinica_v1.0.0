...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex h-11 w-11 items-center justify-center rounded-full bg-brand-100 text-brand-700 font-semibold text-sm dark:bg-brand-900/30 dark:text-brand-400">
          {initials}
        </span>
      ...
      >
        <div className="pb-3 mb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          {user?.role && (
            <span className="mt-1 inline-block rounded-full bg-brand-50 px-2 py-0.5 text-[10px] font-medium text-brand-700 dark:bg-brand-900/20 dark:text-brand-400">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
