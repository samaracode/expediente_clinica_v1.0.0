...
const SECTIONS: Array<{ key: string; label: string; href: (id: string) => string; active: boolean }> = [
  ...
  { key: "psychology", label: "Psicología", href: () => "#", active: false },
  { key: "occupational_therapy", label: "Terapia ocupacional", href: () => "#", active: false },
  { key: "treatment_plan", label: "Plan de tratamiento", href: () => "#", active: false },
